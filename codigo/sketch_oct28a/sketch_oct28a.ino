...
void sendEmail() {
    ...
    message.subject = "Se ha iniciado el sistema de detección de temperatura y humedad ESP32";
    message.addRecipient("User", RECIPIENT_MAIL);

    message.text.content = String("Se ha puesto en marcha el sistema de detección de temperatura y humedad\n") +
                           "Los datos detectados actualmente son los siguientes:\n" +
                           "Temperatura: " + String(tempDeg) + "°C\n" +
                           "Humedad Del Aire: " + String(hum) + "%\n" +
                           "Intensidad De La Luz : " + String(4095 - beam) + "\n" +
                           "Humedad Del Suelo: " + String(4095 - soil) + "\n";
